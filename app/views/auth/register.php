            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div>
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db">
                            <h2 style="color:white">DAFTAR | SIPSKEP</h2>
                        </span>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control form-control-lg" placeholder="Password"
                                        aria-label="Password" aria-describedby="basic-addon1" name="pass1" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="password" class="form-control form-control-lg"
                                        ...
                                        aria-describedby="basic-addon1" name="pass2" required>
                                </div>
                            </div>
                        </div>
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <!-- <button type="submit" name="submit" class="btn btn-block btn-lg btn-info">Sign
                                            Up</button> -->
                                        <input type="submit" name="daftar" class="btn btn-block btn-lg btn-info"
                                            value="Daftar" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <span style="color:white">Sudah punya akun ?</span><a style="color:yellow" href="../">
                            Login</a>
                    </form>
                </div>
            </div>
