...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?= BASEURL ?>/assetsimages/favicon.png">
    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="<?= BASEURL ?>" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">KEMBALI</a>
            </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
