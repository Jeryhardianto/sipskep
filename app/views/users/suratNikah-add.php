 ...
 <div class="page-breadcrumb">
     <div class="row">
         <div class="col-12 d-flex no-block align-items-center">
             <h4 class="page-title">Tambah Surat Keterangan Menikah</h4>
 ...
 <div class="container-fluid">
     <div class="row">
         <div class="col-md-12">
             <div class="card">
                 <div class="card-body">
                     <a href=""><i class="mdi mdi-keyboard-backspace"></i>Kembali</a>
                     <div class="col-md-12">
                         <div class="form-group">
                             ...
                             <div class="form-group mt-3">
                                 ...
                                 <select class="select2 form-select form-control" style="width: 100%; height: 36px"
                 ...
                 <div class="border-top">
                     <div class="card-body">
                         ...
                         <button type="submit" class="btn btn-success text-white">
                             <span class="mdi mdi-plus-box-outline"></span> Simpan
                         </button>
                     </div>
                 </div>
             </div>
